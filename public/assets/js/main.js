(function ($) {
    ...
    /*---------------------
   remove book ride btn when click on list
   --------------------- */

    $('.view-mode li a .ti-view-list').on('click', function () {
        $('.book-ride-grid').addClass('hidden');
    })

    $('.view-mode li a .ti-layout-grid2').on('click', function () {
        $('.book-ride-grid').removeClass('hidden');
    })
