...
@push('title')
    <title>Classic | Divyashakti Enterprise</title>
@endpush

@push('meta')
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Classic | Divyashakti Enterprise" />
    ...
    <meta property="og:image" content="{{ asset('assets/img/home/classic.png') }}" />
    <meta property="og:url" content="https://www.thedivyashakti.com/classic" />
    <meta property="og:site_name" content="Divyashakti Enterprise" />
    <link rel="canonical" href="https://www.thedivyashakti.com/classic">
@endpush
                            ...
                            <div class="product-details-large tab-content">
                                <div class="tab-pane active" id="pro-details1">
                                    <div class="easyzoomeasyzoom--overlay">
                                        <a href="assets/img/home/classic.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content " id="product-details">
                        ...
                        <div class="product-overview">
                            ...
                            <span id="product-range">Range : 60 Km to 70 Km</span> <br>
                            <span id="product-warranty">Warrenty : 2 Year</span>
                        </div>
