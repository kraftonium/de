...
@push('title')
    <title>Divine 24 | Divyashakti Enterprise</title>
@endpush

@push('meta')
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Divine 24 | Divyashakti Enterprise" />
    ...
    <meta property="og:image" content="{{ asset('assets/img/home/divine-24.png') }}" />
    <meta property="og:url" content="https://www.thedivyashakti.com/divine-24" />
    <meta property="og:site_name" content="Divyashakti Enterprise" />
    <link rel="canonical" href="https://www.thedivyashakti.com/divine-24">
@endpush
            ...
            <div class="row">
                            ...
                            <div class="product-details-large tab-content">
                                <div class="tab-pane active" id="pro-details1">
                                    <div class="easyzoomeasyzoom--overlay">
                                        <a href="assets/img/home/divine-24.png">
                                            <img src="assets/img/home/divine-24.png" alt="">
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" id="product-details">
                        ...
                        <div class="product-overview">
                            <h5 class="pd-sub-title">Product Details</h5>
                            <span id="product-battery">Battery Type : Lead Gel Battery</span> <br>
                            <span id="product-range">Range : 90 Km to 100 Km</span> <br>
                            <span id="product-warranty">Warrenty : 6 Year</span>
                        </div>
                        <div class="product-details-custom">
                            ...
                            <div class="product-range">
                                ...
                                <select name="" id="select-range">
                                    ...
                                    <option value="90Km to 100Km" selected>90Km to 100Km</option>
                                </select>
                            </div>
                            ...
                            <div class="product-battery-type ">
                                ...
                                <select name="" id="select-battery">
                                    <option value="Lead Gel Battery" selected>Lead Gel Battery</option>
                        ...
                        <div class="book-ride-grid" style="    margin: 2rem 5rem;">
