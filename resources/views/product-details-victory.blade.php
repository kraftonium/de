...
@push('title')
    <title>Victory | Divyashakti Enterprise</title>
@endpush

@push('meta')
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Victory | Divyashakti Enterprise" />
    ...
    <meta property="og:image" content="{{ asset('assets/img/home/victory.png') }}" />
    <meta property="og:url" content="https://www.thedivyashakti.com/victory" />
    <meta property="og:site_name" content="Divyashakti Enterprise" />
    <link rel="canonical" href="https://www.thedivyashakti.com/victory">
@endpush
                            ...
                            <div class="product-details-large tab-content">
                                <div class="tab-pane active" id="pro-details1">
                                    <div class="easyzoomeasyzoom--overlay">
                                        <a href="assets/img/home/victory.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" id="product-details">
                        ...
                        <div class="product-overview">
                            ...
                            <span id="product-range">Range : 50 Km to 60 Km</span> <br>
                            <span id="product-warranty">Warrenty : 1 Year</span>
                        </div>
