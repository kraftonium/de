...
@push('title')
    <title>Passenger Auto | Divyashakti Enterprise</title>
@endpush

@push('meta')
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Passenger Auto | Divyashakti Enterprise" />
    ...
    <meta property="og:image" content="{{ asset('assets/img/home/passenger.png') }}" />
                            ...
                            <div class="product-details-large tab-content">
                                <div class="tab-pane active" id="pro-details1">
                                    <div class="easyzoomeasyzoom--overlay">
                                        <a href="assets/img/home/passenger.png">
