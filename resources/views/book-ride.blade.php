        ...
        <div class="col-lg-9">
            <div class="contact-message-wrapper">
                ...
                <div class="contact-message">
                    <form id="book_ride_form" action="" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="contact-form-style mb-20">
                                    <input name="ride_date" id="ride_date" placeholder="Date" type="date" onblur="validatecareerRidedate()">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="contact-form-style mb-20">
                                    <input name="ride_time" id="ride_time" placeholder="Time" type="time" onblur="validatecareerRidetime()">
