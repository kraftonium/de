...
@push('title')
    <title>Eternal | Divyashakti Enterprise</title>
@endpush

@push('meta')
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Eternal | Divyashakti Enterprise" />
    ...
    <meta property="og:image" content="{{ asset('assets/img/home/eternal.png') }}" />
    <meta property="og:url" content="https://www.thedivyashakti.com/eternal" />
    <meta property="og:site_name" content="Divyashakti Enterprise" />
    <link rel="canonical" href="https://www.thedivyashakti.com/eternal">
@endpush
                            ...
                            <div class="product-details-large tab-content">
                                <div class="tab-pane active" id="pro-details1">
                                    <div class="easyzoomeasyzoom--overlay">
                                        <a href="assets/img/home/eternal.png">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content" id="product-details">
                        ...
                        <div class="product-overview">
                            ...
                            <span id="product-range">Range : 80 Km to 100 Km</span> <br>
                            <span id="product-warranty">Warrenty : 5 Year</span>
                        </div>
