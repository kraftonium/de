        ...
        <div class="col-lg-9">
            <div class="contact-message-wrapper">
                ...
                <div class="contact-message">
                    <form id="career_form" action="" method="post" class="contact-form-custom"
                        ...
                        <div class="row">
                            ...
                            <div class="contact-form-style mb-20 ">
                                <input name="resume" id="resume" placeholder="Resume" type="file" class="pt-2"
                        ...
                        <div class="col-lg-12">
                            <div class="contact-form-style">
                                ...
                                <button class="submit cr-btn btn-style mt-3" type="button"
                                    id="careerbutton"><span>SUBMIT
                                    </span></button>
                            </div>
                        </div>
