...
@push('title')
    <title>Edit District Active Inactive | Divyashakti Enterprise</title>
@endpush
...
@section('mainsection')
    <div class="page-wrapper">
        <div class="content container-fluid col-md-12">
            ...
            <div class="container">
                <h3 class="h3-heading mb-4">Edit District</h3>

                <form action="{{ url('/update-district-active-inactive') }}/{{ $status->id }}" method="POST">
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select name="zone" id="zone" class="form-select">
                                @foreach ($zones as $zone)
                                    <option value="{{ $zone->id }}" @if ($status->zone == $zone->id) selected @endif>
                                        {{ $zone->zone }}</option>
                                @endforeach
                            </select>
                            <span class="text-danger">
