...
@push('title')
    <title>Manage Area Dealership | Divyashakti Enterprise</title>
@endpush
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <h3>{{ $totalareadealerships }}</h3>
                                </div>
                            </div>
                            <div class="dash-widget-info">
                                <h6 class="text-muted">Total Area Dealerships</h6>
                                <div class="progress progress-sm">
                                    <div class="progress-bar  w-50"></div>
                                </div>
                            </div>
                ...
                <div class="col-md-12 d-flex">
                    ...
                    <div class="card card-table flex-fill">
                        <div class="card-header">
                            <h4 class="card-title">Manage Area Dealers List</h4>
                        </div>
                        <div class="card-body">
