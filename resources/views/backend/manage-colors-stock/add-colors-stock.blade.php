...
@push('title')
    <title>Add Colors Stock | Divyashakti Enterprise</title>
@endpush
    ...
    <div class="page-wrapper">
        <div class="content container-fluid col-md-12">
            ...
            <div class="container">
                ...
                <form action="{{ url('/add-colors-stock-submit') }}" method="POST">
                    @csrf
