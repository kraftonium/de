...
@push('title')
    <title>Edit Colors Stock | Divyashakti Enterprise</title>
@endpush
    ...
    <div class="page-wrapper">
        <div class="content container-fluid col-md-12">
            ...
            <div class="container">
                ...
                <form action="{{ url('/update-colors-stock') }}/{{ $colorstock->id }}" method="POST">
                    @csrf
                    <div class="col-lg-12 form-input-container ">
                        ...
                        <div class="mb-3  ">
                            ...
                            <input type="hidden" id="user_id" name="user_id" value="{{ $colorstock->whose_stock_id }}">

                            <input class="form-control" type="text" id="name"
                                placeholder="Search Name Of Whose Stock" name="whose_stocks_id" oninput="searchUsers()"
                                value="{{ $colorstock->whoseStockColor->name }}">
                            <div id="userList" class="dropdown-menu w-100"
                                style="display: none; position: absolute; max-height: 200px; overflow-y: auto;"></div>
                            <span class="text-danger">
                                @error('whose_stocks_id')
                                    {{ $message }}
                                @enderror
                            </span>
                        </div>
