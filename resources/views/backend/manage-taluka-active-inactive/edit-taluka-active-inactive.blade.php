...
@push('title')
    <title>Edit Taluka Active Inactive | Divyashakti Enterprise</title>
@endpush
...
@section('mainsection')
    <div class="page-wrapper">
        <div class="content container-fluid col-md-12">
            ...
            <div class="container">
                <h3 class="h3-heading mb-4">Edit Taluka</h3>

                <form action="{{ url('/update-taluka-active-inactive') }}/{{ $status->id }}" method="POST">
                    @csrf
                    <div class="col-lg-12 form-input-container ">
                        ...
                        <div class="mb-3  ">
                            ...
                            <input class="form-control" type="text" id="taluka" placeholder="Taluka" name="taluka"
                                value="{{ $status->taluka }}">
                            <span class="text-danger">
                                @error('taluka')
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="user_id" name="user_id" value="{{ $status->whose_dealer }}">
                        ...
                        <div class="mb-3">
                            <label for="district" class="form-label">Under Which District</label>
                            {{-- <input class="form-control" type="text" id="state" placeholder="State" name="state"
                                value="{{ old('state') }}"> --}}
                            <select name="district" id="district" class="form-select">
                                @foreach ($districts as $district)
                                    <option value="{{ $district->id }}" @if ($status->district == $district->id) selected @endif>
