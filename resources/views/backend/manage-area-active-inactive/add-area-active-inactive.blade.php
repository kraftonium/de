...
@push('title')
    <title>Add Area Active Inactive | Divyashakti Enterprise</title>
@endpush
    ...
    <div class="page-wrapper">
        <div class="content container-fluid col-md-12">
            ...
            <div class="container">
                ...
                <form action="{{ url('/add-area-active-inactive-submit') }}" method="POST">
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select name="taluka" id="taluka" class="form-select">
                                @foreach ($talukas as $taluka)
                                    <option value="{{ $taluka->id }}" @if (old('taluka') == $taluka->id) selected @endif>
