...
@section('mainsection')
    <div class="page-wrapper">
        <div class="content container-fluid col-md-12">
            ...
            <div class="container">
                <h3 class="h3-heading mb-4">Add New Area Dealer</h3>
                ...
                <form action="{{ url('/add-dealership-submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 form-input-container">
                        ...
                        {{-- <div class="mb-3 col-12">
                            <label for="whose_dealer">Whose Dealer</label>
                            <input class="form-control" type="text" id="whose_dealer" placeholder="Whose Dealer"
                                name="whose_dealer" value="{{ old('whose_dealer') }}">
                            <span class="text-danger">
                                @error('whose_dealer')
                                    {{ $message }}
                                @enderror
