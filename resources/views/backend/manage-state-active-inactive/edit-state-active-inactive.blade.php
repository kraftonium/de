...
@push('title')
    <title>Add State Active Inactive | Divyashakti Enterprise</title>
@endpush
    ...
    <div class="page-wrapper">
        <div class="content container-fluid col-md-12">
            ...
            <div class="container">
                ...
                <form action="{{ url('/update-state-active-inactive') }}/{{ $status->id }}" method="POST">
                    @csrf
                    <div class="col-lg-12 form-input-container ">
                        ...
                        <div class="mb-3  ">
                            ...
                            <input class="form-control" type="text" id="whose_dealer"
                                placeholder="Search Name Of Who Is Dealer" name="whose_dealer"
                                value="{{ $status->whoseDealer->name }}" oninput="searchUsers()">
